...
export default function Card({nft, setStakeNft}) {
  ...
  return (
    <section className={styles.cardContainer}>
      ...
      {nft.id === 0 ?<><img src="https://i.seadn.io/s/raw/files/bd9d3c055236c1527fb65764d9fd892a.png?auto=format&dpr=1&w=640" /><h3 >id is : {nft.id}</h3></> : ""}
      {nft.id === 1 ? <img src="https://i.seadn.io/s/raw/files/d12b0f36b43032d668e1b954dca4f4c6.png?auto=format&dpr=1&w=640" /> : ""}
      {nft.id === 2 ? <img src="https://i.seadn.io/s/raw/files/eed92a5d395f1c7e785b0bd19ee52797.png?auto=format&dpr=1&w=640" /> : ""}
      {nft.id === 3 ? <img src="https://i.seadn.io/s/raw/files/c0c2e1520cedca641c00ef0a1725c325.png?auto=format&dpr=1&w=512" /> : ""}
